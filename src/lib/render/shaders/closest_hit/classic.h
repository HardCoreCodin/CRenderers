...
inline
#endif
void shadeLambert(Scene *scene, vec3 *Rd, vec3 *P, vec3 *N, vec3 *out_color) {
    f32 d, d2;
    vec3 _l, *L = &_l;
    vec3 light_color,
...
inline
#endif
void shadePhong(Scene *scene, vec3 *Rd, vec3 *P, vec3 *N, vec3 *out_color) {
...
inline
#endif
void shadeBlinn(Scene *scene, vec3 *Rd, vec3 *P, vec3 *N, vec3 *out_color) {
    vec3 light_color, color = scene->ambient_light->color;
    vec3 _l, *L = &_l;
    vec3 _h, *H = &_h;
    f32 d, d2, li, diff, spec;
